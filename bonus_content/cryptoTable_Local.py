...
# --- GitHub CONFIG ---
GITHUB_TOKEN = "XXX"    # Insert your own token here
REPO_OWNER = "XXX"      # Your GitHub name
REPO_NAME = "XXX"       # Your repo name
GITHUB_BRANCH = "main"
GITHUB_FILE_PATH = "tableData.json"
...
def upload_to_github(local_file, repo_file, repo_owner, repo_name, branch, token):
    print("Initialising GitHub commit request...")
    ...
    if get_response.status_code == 200:
        print("Good connection to GitHub repository. Attempting to commit new .json file...")
        sha = get_response.json()["sha"]
        message = "Update tableData.json"
    else:
        sha = None
        message = "Add tableData.json"
    ...
    if put_response.status_code in [200, 201]:
        print("✅ 'tableData.json' commit was successful!")
    else:
        print("❌ 'tableData.json' commit failed:", put_response.status_code, put_response.json())
